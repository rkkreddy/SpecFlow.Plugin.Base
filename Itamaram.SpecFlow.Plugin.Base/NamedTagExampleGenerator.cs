...
namespace Itamaram.SpecFlow.Plugin.Base
{
    public abstract class NamedTagExampleGenerator : ExamplesGenerator
    {
        ...
        public IEnumerable<IEnumerable<string>> GetRows(string args, string path, IEnumerable<string> header)
        {
        ...
        public abstract IEnumerable<IEnumerable<string>> GetRowsInternal(string args, string dir, string specfile, IEnumerable<string> header);
    }
}